...
>
    ...
    {{-- Faint scrim so overlaid light text stays legible (AA) on brand palettes. --}}
    <div class="pointer-events-none absolute inset-0 -z-10 bg-primary/45" aria-hidden="true"></div>

    {{-- Slot content sits above the aurora. --}}
    <div class="relative z-0 p-0">{{ $slot }}</div>
</div>
